  ...
  function createProdid() {
    ...
    switch( $this->format ) {
      case 'xcal':
        ...
        break;
      default:
        $toolbox = new iCalcreatorCalendarComponent();
 ...
 * @since 2.9.6 - 2011-05-14
 */
class iCalcreatorCalendarComponent {
 ...
 */
  function iCalcreatorCalendarComponent() {
 ...
 */
class vevent extends iCalcreatorCalendarComponent {
  var $attach;
  var $attendee;
  var $categories;
  var $comment;
 ...
 */
  function vevent( $config = array()) {
    $this->iCalcreatorCalendarComponent();
 ...
 * @since 2.5.1 - 2008-10-12
 */
class vtodo extends iCalcreatorCalendarComponent {
  var $attach;
  var $attendee;
  var $categories;
  var $comment;
 ...
 * @since 2.5.1 - 2008-10-12
 */
class vjournal extends iCalcreatorCalendarComponent {
  var $attach;
  var $attendee;
  var $categories;
  var $comment;
 ...
 * @since 2.5.1 - 2008-10-12
 */
class vfreebusy extends iCalcreatorCalendarComponent {
  var $attendee;
  var $comment;
  var $contact;
  var $dtend;
 ...
 * @since 2.5.1 - 2008-10-12
 */
class valarm extends iCalcreatorCalendarComponent {
  var $action;
  var $attach;
  var $attendee;
  var $description;
 ...
 * @since 2.5.1 - 2008-10-12
 */
class vtimezone extends iCalcreatorCalendarComponent {
  var $timezonetype;
