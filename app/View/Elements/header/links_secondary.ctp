...
?>
	...
	<?php endif; ?>
	<li class="<?php echo (!empty($this->params['action']) && ($this->params['action']=='contact') )?'active ' :'' ?>nav-item"><?php echo $this->Html->link('Contact', array('plugin' => false, 'controller' => 'pages', 'action' => 'contact'), array('class'=>'nav-link')); ?></li>
	<li class="<?php echo (!empty($this->params['action']) && ($this->params['action']=='about') )?'active ' :'' ?>nav-item"><?php echo $this->Html->link('About', array('plugin' => false, 'controller' => 'pages', 'action' => 'about'), array('class'=>'nav-link')); ?></li>
